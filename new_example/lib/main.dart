  ...
  Widget _buildDefaultRangeDatePickerWithValue() {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        Text(
          'Selected value: ${_getValueText(_rangeDatePickerValueWithDefaultValue)}',
          style: const TextStyle(fontSize: 16, fontWeight: FontWeight.normal),
        ),
      ],
    );
  ...
  Widget _buildDefaultMultiDatePickerWithValue() {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        Text(
          'Selected value: ${_getValueText(_multiDatePickerValueWithDefaultValue)}',
          style: const TextStyle(fontSize: 16, fontWeight: FontWeight.normal),
        ),
      ],
    );
...
class _AlternateYearPickerTestPageState
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildCustomAlternateYearPicker(),
          ],
        ),
      ),
    );
  ...
  Widget _buildCustomAlternateYearPicker() {
    // Custom configuration with enhanced visuals
    final config = CalendarDatePicker2Config(
      calendarType: CalendarDatePicker2Type.single,
      calendarViewMode: CalendarDatePicker2Mode.year,
      yearPickerMode: YearPickerMode.alternative,
      ...
      yearTextStyle: const TextStyle(fontSize: 16, color: Colors.black87),
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Custom AlternateYearPicker',
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 10),
            const Text(
              'Customized with enhanced visuals and different configuration parameters.',
